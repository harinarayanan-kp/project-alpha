      ...
      <footer className="bg-gray-900 text-white py-6 mt-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">GECT Event Platform</h2>
            <p className="text-sm text-gray-400">© {new Date().getFullYear()} Made by TinkerHub 24-25</p>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#fffff" fill="none">
                ...
                <path d="M6.5 4.25C6.5 5.49264 5.49264 6.5 4.25 6.5C3.00736 6.5 2 5.49264 2 4.25C2 3.00736 3.00736 2 4.25 2C5.49264 2 6.5 3.00736 6.5 4.25Z" stroke="currentColor" width="1.5" />
